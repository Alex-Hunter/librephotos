...
CONSTANCE_CONFIG = {
    ...
    "ARCHIVE_DIR": ("/opt/preprod/pictures", "Archive directory (library root)", str),
    "CACHE_DIR": ("/opt/preprod/cache", "Cache directory (thumbnails, embeddings, temp)", str),
    "DUPLICATES_DIR": ("/opt/preprod/pictures/duplicates", "Duplicates folder (archiver output)", str),
    "SCAN_DIR": ("/opt/preprod/pictures/incoming-test", "Scan folder (source for archiver)", str),
    "ARCHIVE_ACTION": ("scan", "Scanning action (scan|archive|both)", str),
    "PERIODIC_SCAN_INTERVAL_MINUTES": (60, "Auto-scan interval (minutes, 0=disabled)", int),
